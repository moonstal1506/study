...
import com.study.study.modules.account.CurrentAccount;
import com.study.study.modules.account.Account;
import com.study.study.modules.account.form.TagForm;
import com.study.study.modules.account.form.ZoneForm;
...
public class StudySettingsController {
    ...
    public String updateStudyTitle(@CurrentAccount Account account, @PathVariable String path, Model model) {
        Study study = studyService.getStudyToUpdateStatus(account, path);
